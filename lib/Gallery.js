...
export default class App extends PureComponent {
  ...
  renderHeader = () => (
    <TouchableOpacity style={{ padding: 20, top: 15, right: 0, position: 'absolute', zIndex: 9 }} onPress={this.props.onClose}>
      {this.props.renderClose ? this.props.renderClose : <Text style={{ color: 'white' }}>Close</Text>}
    </TouchableOpacity>
  )
      ...
      >
        <ImageViewer
          ...
          renderHeader={() => !fullScreen && (
            <TouchableOpacity style={{ padding: 20, top: 20, right: 0, position: 'absolute', zIndex: 9 }} onPress={this.props.onClose}>
